...
<html>
    <head>
        <title>Entertainment | The Pauper's Post</title>
        <meta charset="utf-8">
...
<!--            <button onclick="logOut('./php/leave.php')" style="position: absolute; top: 20px; left: 5px;">LOG OUT</button>-->
            ...
            <div id="news-select" style="text-align: center; margin: 0px 0px 0px 0px;">
                <div style="display: inline-block; margin: auto;">
                    ...
                    <div class="hil-mod" style="border-bottom: 3px solid brown;"><p>Entertainment</p></div>
                    <div class="hil-mod"><p onclick="window.location = '../lifestyle'">Lifestyle</p></div>
                    <div class="hil-mod"><p onclick="window.location = '../other'">Other</p></div>
                </div>
            </div>
        </div>
        <div id="body-cont">
