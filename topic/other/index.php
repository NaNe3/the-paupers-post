...
<html>
    <head>
        <title>Other | The Pauper's Post</title>
        <meta charset="utf-8">
...
<!--            <button onclick="logOut('./php/leave.php')" style="position: absolute; top: 20px; left: 5px;">LOG OUT</button>-->
            ...
            <img id="pro-but" src="../../res/ast/pro.png" style="width: 30px; border-radius: 6px; position: absolute; top: 30px; right: 20px; display: none;">
            
            <div id="news-select" style="text-align: center; margin: 0px 0px 0px 0px;">
                <div style="display: inline-block; margin: auto;">
                    <div class="hil-mod"><p onclick="window.location = '../../'">Home</p></div>
                    <div class="hil-mod"><p onclick="window.location = '../politics'">Politics</p></div>
                    <div class="hil-mod"><p onclick="window.location = '../business'">Business</p></div>
                    <div class="hil-mod"><p onclick="window.location = '../technology'">Technology</p></div>
                    <div class="hil-mod"><p onclick="window.location = '../entertainment'">Entertainment</p></div>
                    <div class="hil-mod"><p onclick="window.location = '../lifestyle'">Lifestyle</p></div>
                    <div class="hil-mod" style="border-bottom: 3px solid brown;"><p>Other</p></div>
                </div>
            </div>
        </div>
        <div id="body-cont">
            <div id="pol-cont" style="width: 80%; display: block; margin: auto; margin-bottom: 80px;">
                <div id="feat-cont" style="width: 50%; display: inline-block; border-right: 1px solid grey; padding-right: 2%;">
<!--                    feat STUFF-->
                </div>
                <div id="side-box" style=" float: right; display: inline-block; width: 46%;">
<!--                    SIDE STUFF-->
                </div>
            </div>
            ...
            <div id="pol-feed-cont" style="width: 80%; display: block; margin: auto; margin: 60px auto;">
                <div id="pol-feed" style="width: 70%; margin: 50px auto;">
                
                </div>
                <button onclick="getNews();" style="width: 200px; display: block; margin: auto; background-color: brown; color: white; border: 0; margin-top: 50px;">Load More</button>
            </div>
